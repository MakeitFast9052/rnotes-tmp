...
import { tabCount, currentTab, loadCache, switchTab, addTab, rmTab, cacheTabs } from '../editor/tabs.js';
...
// NewTab Trigger
document.querySelector('.newTab').addEventListener('click', () => { addTab('', ''); });

// Navbar Event Listeners
document.querySelector('#v-zoom_i').addEventListener('click', () => { zoomIn(); });
document.querySelector('#v-zoom_o').addEventListener('click', () => { zoomOut(); });
